...
intensity(const Ray& ray, const Light l[], int nLights, int depth, int E = -1)
{
	...
	if (iObject != -1)	// Hit an object
	{
		for (int i = 0; i < nLights; i++)
		{
			...
			p = p - 0.01f * l[i].p_eye;
			int jObject = findIntersection(shadowRay, p_shadow, n_shadow, E);

			if (jObject == -1 || jObject == 7)				// Not shadowed
			{
				// Phong reflection
		...
		if (depth < DEPTH)
		{
			...
			p = p - 0.01f * r;
			vec3	I_R = intensity(recursiveRay, l, nLights, depth + 1, E);
	...
	if (useColor)
	{
		...
		{
		case 0:		return  I;
		case 1:		I.x = 0;	return I;
		case 2:		I.y = 0;	return I;
		case 3:		I.z = 0;	return I;
		case 4:		I.x = 0;	I.y = 0;	 return I;
		case 5:		I.y = 0;	I.z = 0;	 return I;
		case 6:		I.x = 0;	I.z = 0;	 return I;
		case 7:		return  I;
		default: 	return	I;
		}
	}
...
#pragma omp master
	...
	center_world[nSpheres] = vec3(0, 0, 0);		radius[nSpheres] = 20.0f;	nSpheres++;
