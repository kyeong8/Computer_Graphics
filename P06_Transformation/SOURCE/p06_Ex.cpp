...
init()
{
	...
	cout << "Keyboard input: 4 for scailing example" << endl;
	cout << "Keyboard input: 5 for scailing wrt a pivot example" << endl;
	cout << "Keyboard input: 6 for scailing wrt a direction example" << endl;
	cout << "Keyboard input: 7 for scailing wrt a pivot example using GLM" << endl;
	cout << "Keyboard input: 8 for scailing wrt a direction example using GLM" << endl;
	cout << "Keyboard input: 9 for a solar system example" << endl;
}
...
rotationPivotExampleGLM()
{
	...
	R = glm::rotate(R, glm::radians(alpha), v);
	glm::vec4 temp(a.x, a.y, a.z, 1);
	result = R * temp;
	cout << endl;
...
solarSystemExample()
{
	...
	float	radius1 = 0.2f;		// Radius of plannet
...
render(GLFWwindow* window)
{
	...
	case 7: scalingPivotExampleGLM();		break;
	case 8: scalingDirectionExampleGLM();	break;
	case 9: solarSystemExample();			break;
	}
}
