...
// Light configuration
vec4	light1(0.0, 0.0, 1.0, 0.0);		// Light position for the square examplevec4	light1(0.0, 0.0, 1.0, 0.0);		// Light position for the square example
vec4	light5(1.0, 1.0, 1.0, 0.0);		// Light position for the cube example
...
main(int argc, char* argv[])
{
	...
	// GLFW: Supported version can be verified in glew.sourceforge.net/basic.hyml
...
init()
{
	...
	cout << "Keyboard input: u for upsideDown on/off" << endl;
	cout << endl;
...
render(GLFWwindow* window)
{
	...
	case 2:									// Demon
	case 3:									// Marble
	case 4: eye = eye1; at = at1; break;	// Logo
	case 5:	eye = eye5; at = at5; break;	// Cube
	case 6: eye = eye6; at = at6; break;	// Floor
	}
	...
	case 2:							 // Demon
	case 3:							 // Marble
	case 4: light = light1;  break;	 // Logo
	case 5:	light = light5;  break;	 // Cube
	case 6: light = light6;  break;	 // Floor
	}
	setupLight(light);
	...
	case 2: // Demon
		{
			glBindTexture(GL_TEXTURE_2D, texID[1]);	// Demon texture
			drawTexturedSquare(textureNumRepeats);
		}
		break;
	case 3: // Marble
